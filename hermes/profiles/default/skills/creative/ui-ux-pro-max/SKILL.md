---
name: ui-ux-pro-max
description: "Use for UI/UX design, landing pages, dashboards, components, design systems, colors, typography, accessibility, responsive layouts, animations, charts, and visual polish. Provides searchable UI/UX intelligence from UI UX Pro Max."
version: 2.5.0
...
metadata:
  hermes:
    tags: [ui, ux, design, design-system, accessibility, typography, color-palette, charts, frontend]
    homepage: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill
---

# UI UX Pro Max

AI-powered design intelligence for professional web and mobile UI/UX: design systems, styles, palettes, typography, UX checks, charts, and stack-specific implementation guidance.
...
```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name"
```
...
```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard"
```
...
```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <stack>
```
...
```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "atlantafx primer enterprise theme" --stack javafx
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "enterprise tableview density permission" --stack javafx
```
...
```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"
```
...
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "minimalism dark mode" --domain style

# Get UX best practices for search interaction and loading
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "search loading animation" --domain ux
```

### Step 4: Stack Guidelines

```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack react-native
```
...
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system -f markdown
```
...
This skill was installed from https://github.com/nextlevelbuilder/ui-ux-pro-max-skill into Keith's Hermes profile.

Search script path:

```bash
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "<query>" --design-system
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "<query>" --domain ux
python3 /root/.hermes/profiles/keith/skills/creative/ui-ux-pro-max/scripts/search.py "<query>" --stack nextjs
```

Use this skill before changing any website/app UI so the design decisions are grounded in the searchable UI UX Pro Max database.
